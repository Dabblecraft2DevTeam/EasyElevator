    ...
    for (int x = xStart; x <= xEnd; x++) {
      for (int z = zStart; z <= zEnd; z++)
      {
        ...
        if (((x == xStart) || (x == xEnd) || (z == zStart) || (z == zEnd)) && (
          (tempBlock.getType().equals(Material.WOODEN_DOOR)) || (tempBlock.getType().equals(Material.IRON_DOOR_BLOCK)))) {
      ...
      for (int z = zStart; z <= zEnd; z++)
      {
        ...
        if ((x == xStart) || (x == xEnd) || (z == zStart) || (z == zEnd)) {
          if (b)
          {
            ...
            (this.redstoneOutDoorBlock.contains(tempBlock)))
          {
      ...
      for (int z = zStart; z <= zEnd; z++)
      {
        ...
        if ((x == xStart) || (x == xEnd) || (z == zStart) || (z == zEnd)) {
          if (b)
          {
            ...
            (this.redstoneOutFloorBlock.contains(tempBlock)))
          {
